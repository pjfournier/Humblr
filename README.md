...
- **Little draggable avatar**: A small borderless avatar face shows up on the second monitor (pink/purple dominant theme). Drag it around. Left-click to interact (brings main window or triggers real-time reaction based on what you're doing). Right-click for quick actions (wallpaper, post on X, webcam, demand submission, search stories). Expression changes with your corruption level. It's the always-visible "presence" of Humblr.
...
- **Slow digging personal questions + screen commentary**: Proactively asks personal questions about who you are (life, kinks, routines, secrets) using long-term memory for follow-ups and deeper probing. Constantly comments in detail on exactly what's open on your screens (windows, tabs, X posts, apps) and ties it to your submission and its ownership. All autonomous, dynamic, learning over time.
